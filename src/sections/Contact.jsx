...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "ethan.hc.leung@gmail.com",
        href: "mailto:ethan.hc.leung@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+1 (437) 973-4982",
        href: "tel:+14379734982",
    },
    {
        icon: MapPin,
        label: "Location",
      ...
      <head><title>Contact - Ethan Leung</title></head>
        ...
        <div>
            {[...Array(30)].map((_, i) => {
                ...
                const top = row * cellHeight + Math.random() * cellHeight * 0.5;
                return (
                    <img
                        src="/FloatingE.png"
                        draggable="false"
                        key={i}
                        className="absolute w-15 h-15 rounded-full select-none pointer-events-none will-change-transform"
                        style={{
                            left: `${left}%`,
                            top: `${top}%`,
                            opacity: 0.15 * (1 - top / 90),
