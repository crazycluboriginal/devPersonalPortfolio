            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    <div className="animate-fade-in">
                        ...
                        Student • Rotman Commerce, University of Toronto
                        </span>
                    </div>
                {/* Headline */}
                ...
                <div className="flex items-center gap-4 mt-6 animate-fade-in animation-delay-400 ">
                    ...
                    {[
                        {icon : FaGithub, href: "https://github.com/crazycluboriginal"},
                        {icon : FaLinkedin, href: "https://linkedin.com/in/ethan--leung"},
                        {icon : FaInstagram, href: "https://instagram.com/vectorgraphicz"}
                    ].map((social, idx) => (
                        <a
                            key={idx}
                            href={social.href}
                ...
                <div className="relative animate-fade-in animation-delay-300">
                    ...
                    <div className="relative max-w-md mx-auto">
                        ...
                        <div className="relative glass rounded-3xl p-2 glow-border">
                            <img src="/profile-photo.jpg" alt="Ethan L" className="w-full aspect-[4/5] obejct-cover rounded-2xl"/>
                            {/*Floating badge*/}
             ...
             <div className="mt-20 animate-fade-in animation-delay-600">
                 <p className="text-lg text-muted-foreground mb-6 text-center">My skills</p>
