    ...
    return <section id="projects" className="py-32 relative overflow-hidden">
      ...
      {/* Section Header */}
        <div className="text-center mx-auto max-w-3xl mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-secondary-foreground">Projects that help me
                <span className="font-serif italic font-normal text-white"> make an impact.</span></h2>
            <p className="text-muted-foreground animate-fade-in animation-delay-200">
                A selection of my most recent work, from entertainment applications to real problem-solving tools.
            </p>
        </div>
